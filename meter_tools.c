...
*/
  ...
  /* 0x2e '.' */ 0x0040,    /* 0000 0000 0100 000x k */
...
*/
  ...
  /* 0x3a ':' */ 0x0220,    /* 0000 0010 0010 000x gl */
...
E  |/|\|  C
    ...
    MLK
     D
*/
  /* 0x6a 'j' */ 0x7000,    /* 0111 0000 0000 000x bcd     */

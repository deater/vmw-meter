...
#define MPL115A2_REGISTER_PRESSURE_MSB		0x00 // 10-bit pressure MSB
#define MPL115A2_REGISTER_PRESSURE_LSB		0x01 // 10-bit Pressure LSB
#define MPL115A2_REGISTER_TEMP_MSB		0x02 // 10-bit Temperature MSB
#define MPL115A2_REGISTER_TEMP_LSB		0x03 // 10-bit Temperature LSB
...
#define MPL115A2_REGISTER_STARTCONVERSION 	0x12 // start conversion

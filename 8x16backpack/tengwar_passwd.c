...
static void update_our_display(unsigned short *display_buffer, int i2c_fd,int no_display) {

	/* Write Display */
	if (!no_display) {
		update_8x16_display(i2c_fd,
			HT16K33_ADDRESS0,display_buffer,0,BROKEN);
	}
	else {
...
int main(int arg, char **argv) {
	...
	unsigned short framebuffer[FRAME_WIDTH];

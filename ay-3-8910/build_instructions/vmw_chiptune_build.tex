...
\begin{figure}[tbp]
\centering
\includegraphics[width=4in]{figs/0416_display_wo_displays.jpg}
\caption{Picture of display board showing screw/nut
placement.~\label{figs:nuts_places}}
\end{figure}
...
\item 14-segment LED boards
	...
	\begin{enumerate}
		...
		\item Now set up the spacers and screws.
			...
			\item  Figures~\ref{figs:nut_diagram} and
				~\ref{figs:nuts_places} have
				possibly helpful diagrams.

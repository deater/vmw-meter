...
By moving to SPI it reduced ym\_play\_frame to 8ms, allowing
...
\caption{Not very helpful crimping diagram.~\label{figure:crimping}}
\end{figure}


\begin{figure}[tph]
\includegraphics{figs/holes}
...
\item The oscillator too close to the chip
